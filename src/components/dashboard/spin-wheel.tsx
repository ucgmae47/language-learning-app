...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    label: "Progress",
    emoji: "📊",
    description: "Your learning stats, streaks, and milestones at a glance",
    href: "/progress",
  ...
  },
  {
    ...
    label: "Analyzer",
    emoji: "🔍",
    description: "Paste any text to instantly detect its CEFR difficulty level",
    href: "/analyzer",
  ...
  },
  {
    ...
    label: "Achievements",
    emoji: "🏆",
    description: "Unlock badges and track your learning milestones",
    href: "/achievements",
  ...
  },
  {
    ...
    label: "Planner",
    emoji: "🗓️",
    description: "Get a personalized weekly study plan tailored to your level and goals",
    href: "/planner",
    gradient: "from-slate-500 via-zinc-500 to-gray-600",
    glowColor: "rgba(100,116,139,0.55)",
    textAccent: "text-slate-300",
