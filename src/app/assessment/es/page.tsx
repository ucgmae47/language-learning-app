...
import { QUESTIONS_ES } from "@/lib/assessment/questions";

export const metadata: Metadata = {
  title: "Spanish Proficiency Assessment | LinguaPath",
  description: "Find out your Spanish CEFR level in about 5 minutes.",
};

export default async function SpanishAssessmentPage() {
