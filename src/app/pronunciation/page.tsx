      ...
      <header className="sticky top-16 z-40 flex items-center justify-between border-b border-white/8 bg-gradient-to-r from-[#0d0d1e] to-[#12122a] px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-rose-500 to-pink-600 shadow-lg shadow-rose-500/30">
              <span className="text-base" aria-hidden="true">🎙️</span>
            </div>
            <div>
              <h1 className="text-lg font-extrabold leading-none text-white">Pronunciation Coach</h1>
              <p className="text-xs text-slate-400">Practice speaking with AI feedback</p>
            </div>
          </div>
        </div>
