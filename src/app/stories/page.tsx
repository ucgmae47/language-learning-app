      ...
      <div className="mx-auto max-w-3xl">
        ...
        {!stories || stories.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
            ...
            <p className="mt-4 font-medium text-slate-700">No stories yet</p>
              ...
              return (
                <li key={story.id}>
                  <Link
                    ...
                    className="flex items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-md"
                  >
