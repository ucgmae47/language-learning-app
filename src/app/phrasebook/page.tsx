      ...
      <header className="sticky top-16 z-40 flex items-center justify-between border-b border-white/8 bg-gradient-to-r from-[#0d0d1e] to-[#12122a] px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-extrabold leading-none text-white">Phrasebook</h1>
              <p className="text-xs text-slate-400">Essential phrases for every situation</p>
            </div>
          </div>
        </div>

        <div className="text-sm text-slate-400">
          <span className="font-semibold text-violet-400">{cefrLevel}</span>
          {" · "}
