  ...
  return (
    <div className="min-h-screen bg-[#07070f]">
      <header className="sticky top-0 z-20 flex items-center justify-between border-b border-white/8 bg-gradient-to-r from-[#0d0d1e] to-[#12122a] px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-extrabold leading-none text-white">Text Level Analyzer</h1>
              <p className="text-xs text-slate-400">Discover the difficulty of any text</p>
            </div>
          </div>
        </div>

        <div className="text-sm text-slate-400">
          <span className="font-semibold text-amber-400">{cefrLevel}</span>
          {" · "}
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        <AnalyzerClient language={language} />
      </main>
    </div>
  );
}
