...
const PROTECTED_PREFIXES = ["/dashboard", "/onboarding", "/stories", "/chat", "/assessment", "/crossword", "/drills", "/flashcards", "/settings", "/chat-room", "/journal", "/news", "/gameroom", "/gameroom/cannon", "/gameroom/word-soup", "/gameroom/verb-race", "/gameroom/pictionary"];
